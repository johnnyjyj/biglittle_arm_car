...
sys.path.append("room_classifier")
...
config_file = '../configs/fcaf3d/fcaf3d_8x2_scannet-3d-18class.py'
checkpoint_file = '../checkpoints/fcaf3d_8x2_scannet-3d-18class_20220805_084956.pth'  # 记得下载
...
def listener():
    ...
    rospy.Subscriber('/rtabmap/map_assembler/cloud_map', PointCloud2, callback)
