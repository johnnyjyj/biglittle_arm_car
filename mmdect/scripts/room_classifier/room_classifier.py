...
class RoomClassifier:
    ...
    def load_training_data_and_vectorize(self, detector_type):
        ...
        features_train, features_test, self.labels_train, self.labels_test = cross_validation.train_test_split(
            features_for_each_label, labels_shuffled, test_size=0.1, random_state=1983)
